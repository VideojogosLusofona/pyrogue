...
ARCHETYPES = {
    "PlayerWarrior": Archetype(
        ...
        has_xp = True,
        abilities = [ ABILITIES["ShieldBash"] ],
        ),
    "PlayerMage": Archetype(
        display_name = "Mage", 
        filename = "images/mage.png",
        controller = (KeyboardController),
        text_color = (0, 240, 240),
        max_health_base = 60,
        ...
        max_mp_per_level = 10,
        mp_recover_base = 5,
        mp_recover_per_level = 1,
        max_stamina_base = 80,
        max_stamina_per_level = 5,
        stamina_recover_base = 1,
        stamina_recover_per_level = 0.25,
        attack_power_base = 5,
        attack_power_per_level = 4,
        defense_power_base = 0,
        defense_power_per_level = 0,
        melee_stamina_cost_base = 2,
        melee_stamina_cost_per_level = 0,
        has_xp = True,
        abilities = [ ABILITIES["Firebolt"], ABILITIES["Fireball"] ],
        ),
    "Blob": Archetype(
        display_name = "Blob", 
        ...
        abilities = [ ABILITIES["ToxicLick"] ],
        ),
    "BlobBoss": Archetype(
        display_name = "Blob BOss", 
        filename = "images/blob.png",
